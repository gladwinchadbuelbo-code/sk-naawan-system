...
const submitProposal = async () => {
  ...
  try {
    ...
    console.log('API Request: POST http://127.0.0.1:5000/api/proposals/budget-proposals', payload)

    const response = await fetch('http://localhost:5000/api/proposals/budget-proposals', {
      method: 'POST',
      headers: { 
